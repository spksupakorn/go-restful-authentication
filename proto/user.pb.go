...
// CreateUserResponse returns created user and tokens
...
// ListUsersRequest with pagination
...
// DeleteUserRequest for deleting user
...
// LoginResponse returns user and tokens
...
const file_proto_user_proto_rawDesc = "" +
	...
	".user.UserR\x04user\x12!\n" +
	"\faccess_token\x18\x02 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x03 \x01(\tR\frefreshToken2\xf8\x02\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponse\x120\n" +
	"\x05Login\x12\x12.user.LoginRequest\x1a\x13.user.LoginResponseB;Z9github.com/spksupakorn/go-restful-authentication/proto/pbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	12, // 16: user.UserService.Login:output_type -> user.LoginResponse
